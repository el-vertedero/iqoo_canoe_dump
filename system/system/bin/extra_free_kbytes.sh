...
echo "The current_major version is: $current_major"
echo "The current_minor version is: $current_minor"
target_major=5
target_minor=15
# 比较内核版本号
if [ $current_major -gt $target_major ] || [ $current_major -eq $target_major  -a $current_minor -ge $target_minor ]; then
